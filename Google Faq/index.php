...
<?php
 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     <?php
     foreach ($db as $faqs) {
         echo '<h2 style= "font-size: 24px; padding: 5px 100px; font-weight: lighter; text-align:inherit">'.$faqs['question'].'</h2>';
         echo '<p style= "font-size:16px; color: grey; padding: 5px 100px;">'.$faqs['answer'].'</p>';
     }
     ?>
   </body>
 </html
